'''This ETL file is a practice exercise from the Courseera course: Python Project for Data Engineering
by IBM. The data used here to run the code is downloaded from the course content'''
